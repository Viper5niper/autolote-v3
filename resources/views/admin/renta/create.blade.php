...
<div class="container">
    <div class="row">
        <div class="col-lg-11  card d-flex justify-content-center mx-auto my-3 p-5">
            ...
            <hr>
            <div id="ac1">
                @include('admin.renta.partials-create._form-ac1')
            </div>
            <div id="ac2">
                @include('admin.renta.partials-create._form-ac2')
            </div>
            <div id="form">
                <form action="">
                    @include('admin.renta.partials-create._form',['btnText'=>'Registrar Renta'])
                </form>
            </div>
        </div>
    </div>
