...
<div class="form-row">
    ...
    <div class="form-group col-md-6 first"> 
      ...
      @enderror" id="vehiculo_vto" placeholder="" value="{{old('vto',$vehiculo->vto)}}" onKeyUp="mayus(this);" required>
      @error('vto')
      <div class="invalid-feedback">{{ $message }}</div>
        @enderror 
    </div>
    <div class="form-group col-md-6 first"> 
      ...
      @enderror" id="vehiculo_anio" placeholder="2020" value="{{old('anio',$vehiculo->anio)}}" onKeyUp="mayus(this);"  required>
      @error('anio')
      <div class="invalid-feedback">{{ $message }}</div>
        @enderror 
    </div>
    <div class="form-group col-md-6 first"> 
        ...
        @enderror" id="vehiculo_marca" placeholder="TOYOTA" value="{{old('marca',$vehiculo->marca)}}" onKeyUp="mayus(this);"  required>
        @error('marca')
        <div class="invalid-feedback">{{ $message }}</div>
          @enderror 
    </div>
    <div class="form-group col-md-6 first"> 
        ...
        @enderror" id="vehiculo_modelo" placeholder="COROLLA" value="{{old('modelo',$vehiculo->modelo)}}" onKeyUp="mayus(this);"  required>
        @error('modelo')
        <div class="invalid-feedback">{{ $message }}</div>
          @enderror 
    </div>
    <div class="form-group col-md-6 first"> 
      ...
      @enderror" id="vehiculo_capacidad" placeholder="" value="{{old('capacidad',$vehiculo->capacidad)}}" onKeyUp="mayus(this);"  required>
      @error('capacidad')
      <div class="invalid-feedback">{{ $message }}</div>
        @enderror 
    </div>
    <div class="form-group col-md-6 first"> 
      ...
      @enderror" id="vehiculo_tipo" placeholder="" value="{{old('tipo',$vehiculo->tipo)}}" onKeyUp="mayus(this);" required>
      @error('tipo')
      <div class="invalid-feedback">{{ $message }}</div>
        @enderror 
    </div>
    <div class="form-group col-md-6 first"> 
      ...
      @enderror" id="vehiculo_clase" placeholder="" value="{{old('clase',$vehiculo->clase)}}" onKeyUp="mayus(this);"  required>
      @error('clase')
      <div class="invalid-feedback">{{ $message }}</div>
        @enderror 
    </div>
    <div class="form-group col-md-6 first"> 
      ...
      @enderror" id="vehiculo_traccion" placeholder="" value="{{old('traccion',$vehiculo->traccion)}}" onKeyUp="mayus(this);"  required>
      @error('traccion')
      <div class="invalid-feedback">{{ $message }}</div>
        @enderror 
    </div>
    <div class="form-group col-md-6 first"> 
      ...
      @enderror" id="vehiculo_dominio" placeholder="" value="{{old('dominio',$vehiculo->dominio)}}" onKeyUp="mayus(this);" required>
      @error('dominio')
      <div class="invalid-feedback">{{ $message }}</div>
        @enderror 
    </div>
    <div class="form-group col-md-6 first"> 
      ...
      @enderror" id="vehiculo_calidad" placeholder="" value="{{old('calidad',$vehiculo->calidad)}}" onKeyUp="mayus(this);" required>
      @error('calidad')
      <div class="invalid-feedback">{{ $message }}</div>
        @enderror 
    </div>
    <div class="form-group col-md-6 first"> 
        ...
        @enderror" id="vehiculo_color" placeholder="ROJO" value="{{old('color',$vehiculo->color)}}" onKeyUp="mayus(this);"  required>
        @error('color')
        <div class="invalid-feedback">{{ $message }}</div>
          @enderror 
    </div>
    <div class="form-group col-md-6 first"> 
      ...
      @enderror" id="vehiculo_nchasis" placeholder="" value="{{old('n_chasis',$vehiculo->n_chasis)}}" onKeyUp="mayus(this);" required>
      @error('n_chasis')
      <div class="invalid-feedback">{{ $message }}</div>
        @enderror 
    </div>
    <div class="form-group col-md-6 first"> 
        ...
        @enderror" id="vehiculo_nmotor" placeholder="" value="{{old('n_motor',$vehiculo->n_motor)}}" onKeyUp="mayus(this);" required>
        @error('n_motor')
        <div class="invalid-feedback">{{ $message }}</div>
          @enderror 
    </div>
    <div class="form-group col-md-6 first"> 
        ...
        @enderror" id="vehiculo_nvin" placeholder="" value="{{old('n_vin',$vehiculo->n_vin)}}" onKeyUp="mayus(this);" required>
        @error('n_vin')
        <div class="invalid-feedback">{{ $message }}</div>
          @enderror 
    </div>
...
<div class="form-button pt-4"> <button type="submit" class="btn btn-primary btn-block btn-lg" ><span>{{$btnText}}</span></button> </div>
