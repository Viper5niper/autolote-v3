...
<div class="form-row">
  <div class="form-group col-md-6 first">
    ...
    <input type="text" name="placa" class="form-control @error('placa') is-invalid 
      ...
      onKeyUp="toUpperCaseField(this);n_placa_mask(this);"  required>
    @error('placa')
  ...
  <div class="form-group col-md-6 first">
    ...
    <input type="month" name="vto" class="form-control @error('vto') is-invalid 
      @enderror" id="vehiculo_vto" placeholder="" value="{{old('vto',$vehiculo->vto)}}" onKeyUp="toUpperCaseField(this);"
      required>
    @error('vto')
    <div class="invalid-feedback">{{ $message }}</div>
    @enderror
  ...
  <div class="form-group col-md-6 first">
    ...
    <input type="number" name="anio" max="4000" class="form-control @error('anio') is-invalid 
      @enderror" id="vehiculo_anio" placeholder="2020" value="{{old('anio',$vehiculo->anio)}}" onKeyUp="toUpperCaseField(this);"
      required>
    @error('anio')
    <div class="invalid-feedback">{{ $message }}</div>
    @enderror
  ...
  <div class="form-group col-md-6 first">
    ...
    <input type="text" name="tipo" class="form-control @error('tipo') is-invalid 
      @enderror" id="vehiculo_tipo" placeholder="" value="{{old('tipo',$vehiculo->tipo)}}" onKeyUp="toUpperCaseField(this);"
      required>
    @error('tipo')
    <div class="invalid-feedback">{{ $message }}</div>
    @enderror
  ...
  <div class="form-group col-md-6 first">
    ...
    <input type="text" name="clase" class="form-control @error('clase') is-invalid 
      @enderror" id="vehiculo_clase" placeholder="" value="{{old('clase',$vehiculo->clase)}}" onKeyUp="toUpperCaseField(this);"
      required>
    @error('clase')
    <div class="invalid-feedback">{{ $message }}</div>
    @enderror
  ...
  <div class="form-group col-md-6 first">
    ...
    <input type="text" name="n_vin" class="form-control @error('n_vin') is-invalid 
        @enderror" id="vehiculo_nvin" placeholder="" value="{{old('n_vin',$vehiculo->n_vin)}}" onKeyUp="toUpperCaseField(this);"
      required>
    @error('n_vin')
    <div class="invalid-feedback">{{ $message }}</div>
    @enderror
