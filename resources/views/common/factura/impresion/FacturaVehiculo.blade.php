<!-- BIEN ES HORA DE USAR LA IMAGINACION+32-->
        ...
        <label style="margin-left: 8mm;margin-top: 72mm;position: absolute;">{{$factura->payload['descripcion']}}</label>
        ...
        <label style="margin-left: 8mm;margin-top: 115mm;position: absolute;"></label>
        <label style="margin-left: 8mm;margin-top: 120mm;position: absolute;"></label>
